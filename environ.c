...
/**
 * _myenviron - function will print the current environment
...
/**
 * _getenviron - function gets the value of an environ variable.
 * @info: Structure containing potential arguments. Used to maintain
 * @name: env var name
 *
...
/**
 * _mysetenviron - function Initialize a new environment variable,
...
/**
 * _myunsetenviron - function Removes an environment variable
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *  Return: Always returns 0
 */
